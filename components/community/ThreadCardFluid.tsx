    ...
    >
      ...
      <div className="flex items-center gap-4">
        <button
          ...
          className={cn(
            "flex items-center gap-1.5 text-sm font-medium min-h-[44px] sm:min-h-0",
        ...
        <button
          className={cn(
            "flex items-center gap-1.5 text-sm font-medium text-muted-foreground min-h-[44px] sm:min-h-0",
            "transition-all duration-200",
