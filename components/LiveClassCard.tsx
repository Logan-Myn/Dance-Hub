...
export default function LiveClassCard({ liveClass, communitySlug, onClick }: LiveClassCardProps) {
  ...
  return (
    <div className="relative w-full">
      ...
      {/* Tooltip renders to document.body so it escapes sibling-row stacking. */}
      {tooltipPos && typeof window !== 'undefined' &&
        createPortal(
          <div
            className="fixed z-[100] w-64 bg-white border border-gray-200 rounded-lg shadow-lg p-3 pointer-events-none"
